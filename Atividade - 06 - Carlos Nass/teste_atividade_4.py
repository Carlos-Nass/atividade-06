import unittest
from atividade_4 import WorkHoursCalculator
...
class TestWorkHoursCalculator(unittest.TestCase):
    ...
    def test_HoursDifference(self):
        ...
        self.assertEqual(self.calculator.HoursDifference('11:00', '1330'), 2.5)

    def test_WorkHours(self):
        hours = [('09:00', '1730'), ('0715', '1545'), ('1100', '13:30')]
        self.assertEqual(self.calculator.WorkHours(hours), 19.5)

    def test_ValidateFormat(self):
        self.assertTrue(self.calculator.ValidateFormat('0400'))
